...
// GetHeadquarters returns the Headquarters field value if set, zero value otherwise.
func (o *Faction) GetHeadquarters() string {
	if o == nil || IsNil(o.Headquarters) {
		var ret string
		return ret
	}
...
// GetHeadquartersOk returns a tuple with the Headquarters field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetHeadquarters gets a reference to the given string and assigns it to the Headquarters field.
