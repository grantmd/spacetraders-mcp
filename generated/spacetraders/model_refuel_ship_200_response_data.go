...
type RefuelShip200ResponseData struct {
	...
	Cargo       *ShipCargo        `json:"cargo,omitempty"`
}
...
func (o *RefuelShip200ResponseData) GetCargo() ShipCargo {
...
// and a boolean to check if the value has been set.
func (o *RefuelShip200ResponseData) GetCargoOk() (*ShipCargo, bool) {
	if o == nil || IsNil(o.Cargo) {
		return nil, false
	}
	return o.Cargo, true
...
func (o *RefuelShip200ResponseData) HasCargo() bool {
	if o != nil && !IsNil(o.Cargo) {
		return true
	}
...
// SetCargo gets a reference to the given ShipCargo and assigns it to the Cargo field.
func (o *RefuelShip200ResponseData) SetCargo(v ShipCargo) {
	o.Cargo = &v
}
