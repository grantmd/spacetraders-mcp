...
func NewCreateChart201ResponseData(chart Chart, waypoint Waypoint, agent Agent) *CreateChart201ResponseData {
...
func (o *CreateChart201ResponseData) GetAgent() Agent {
	if o == nil {
		var ret Agent
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateChart201ResponseData) GetAgentOk() (*Agent, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Agent, true
...
func (o *CreateChart201ResponseData) SetAgent(v Agent) {
	o.Agent = v
}
