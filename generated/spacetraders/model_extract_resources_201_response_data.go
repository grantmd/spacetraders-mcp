...
func (o *ExtractResources201ResponseData) GetModifiers() []WaypointModifier {
...
// and a boolean to check if the value has been set.
func (o *ExtractResources201ResponseData) GetModifiersOk() ([]WaypointModifier, bool) {
	if o == nil || IsNil(o.Modifiers) {
		return nil, false
	}
...
func (o *ExtractResources201ResponseData) HasModifiers() bool {
	if o != nil && !IsNil(o.Modifiers) {
		return true
	}
...
func (o *ExtractResources201ResponseData) SetModifiers(v []WaypointModifier) {
	o.Modifiers = v
}
