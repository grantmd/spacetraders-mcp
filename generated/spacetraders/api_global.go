...
type GlobalAPI interface {
	...
	/*
		...
		This also includes a few global elements, such as announcements, server reset dates and leaderboards.
			...
			@return GlobalAPIGetStatusRequest
	*/
	GetStatus(ctx context.Context) GlobalAPIGetStatusRequest

	// GetStatusExecute executes the request
	//  @return GetStatus200Response
	GetStatusExecute(r GlobalAPIGetStatusRequest) (*GetStatus200Response, *http.Response, error)
	...
	/*
		...
		If you are new to SpaceTraders, It is recommended to register with the COSMIC faction, a faction that is well connected to the rest of the universe. After registering, you should try our interactive [quickstart guide](https://docs.spacetraders.io/quickstart/new-game) which will walk you through a few basic API requests in just a few minutes.
			...
			@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			@return GlobalAPIRegisterRequest
	*/
	Register(ctx context.Context) GlobalAPIRegisterRequest

	// RegisterExecute executes the request
	//  @return Register201Response
	RegisterExecute(r GlobalAPIRegisterRequest) (*Register201Response, *http.Response, error)
}

// GlobalAPIService GlobalAPI service
type GlobalAPIService service

type GlobalAPIGetStatusRequest struct {
	ctx        context.Context
	ApiService GlobalAPI
}

func (r GlobalAPIGetStatusRequest) Execute() (*GetStatus200Response, *http.Response, error) {
...
This also includes a few global elements, such as announcements, server reset dates and leaderboards.
	...
	@return GlobalAPIGetStatusRequest
*/
func (a *GlobalAPIService) GetStatus(ctx context.Context) GlobalAPIGetStatusRequest {
	return GlobalAPIGetStatusRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return GetStatus200Response
func (a *GlobalAPIService) GetStatusExecute(r GlobalAPIGetStatusRequest) (*GetStatus200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GlobalAPIService.GetStatus")
	if err != nil {
...
type GlobalAPIRegisterRequest struct {
	ctx             context.Context
	ApiService      GlobalAPI
	registerRequest *RegisterRequest
}

func (r GlobalAPIRegisterRequest) RegisterRequest(registerRequest RegisterRequest) GlobalAPIRegisterRequest {
	r.registerRequest = &registerRequest
	return r
}

func (r GlobalAPIRegisterRequest) Execute() (*Register201Response, *http.Response, error) {
...
If you are new to SpaceTraders, It is recommended to register with the COSMIC faction, a faction that is well connected to the rest of the universe. After registering, you should try our interactive [quickstart guide](https://docs.spacetraders.io/quickstart/new-game) which will walk you through a few basic API requests in just a few minutes.
	...
	@return GlobalAPIRegisterRequest
*/
func (a *GlobalAPIService) Register(ctx context.Context) GlobalAPIRegisterRequest {
	return GlobalAPIRegisterRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return Register201Response
func (a *GlobalAPIService) RegisterExecute(r GlobalAPIRegisterRequest) (*Register201Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GlobalAPIService.Register")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
