...
type FleetAPI interface {
	...
	*/
	...
	ExtractResourcesWithSurveyExecute(r FleetAPIExtractResourcesWithSurveyRequest) (*ExtractResourcesWithSurvey201Response, *http.Response, error)
	...
	*/
	...
	/*
		GetShipModules Get Ship Modules

		Get the modules installed on a ship.

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param shipSymbol The symbol of the ship
		@return FleetAPIGetShipModulesRequest
	*/
	GetShipModules(ctx context.Context, shipSymbol string) FleetAPIGetShipModulesRequest

	// GetShipModulesExecute executes the request
	//  @return GetShipModules200Response
	GetShipModulesExecute(r FleetAPIGetShipModulesRequest) (*GetShipModules200Response, *http.Response, error)
	...
	*/
	...
	/*
		InstallShipModule Install Ship Module

		Install a module on a ship. The module must be in your cargo.

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param shipSymbol The symbol of the ship
		@return FleetAPIInstallShipModuleRequest
	*/
	InstallShipModule(ctx context.Context, shipSymbol string) FleetAPIInstallShipModuleRequest

	// InstallShipModuleExecute executes the request
	//  @return InstallShipModule201Response
	InstallShipModuleExecute(r FleetAPIInstallShipModuleRequest) (*InstallShipModule201Response, *http.Response, error)
	...
	*/
	...
	PatchShipNavExecute(r FleetAPIPatchShipNavRequest) (*PatchShipNav200Response, *http.Response, error)
	...
	*/
	...
	/*
		RemoveShipModule Remove Ship Module

		Remove a module from a ship. The module will be placed in cargo.

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param shipSymbol The symbol of the ship
		@return FleetAPIRemoveShipModuleRequest
	*/
	RemoveShipModule(ctx context.Context, shipSymbol string) FleetAPIRemoveShipModuleRequest

	// RemoveShipModuleExecute executes the request
	//  @return RemoveModule201Response
	RemoveShipModuleExecute(r FleetAPIRemoveShipModuleRequest) (*RemoveModule201Response, *http.Response, error)
...
func (r FleetAPIExtractResourcesWithSurveyRequest) Execute() (*ExtractResourcesWithSurvey201Response, *http.Response, error) {
...
//
//	@return ExtractResourcesWithSurvey201Response
func (a *FleetAPIService) ExtractResourcesWithSurveyExecute(r FleetAPIExtractResourcesWithSurveyRequest) (*ExtractResourcesWithSurvey201Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ExtractResourcesWithSurvey201Response
	)
...
type FleetAPIGetShipModulesRequest struct {
	ctx        context.Context
	ApiService FleetAPI
	shipSymbol string
}

func (r FleetAPIGetShipModulesRequest) Execute() (*GetShipModules200Response, *http.Response, error) {
	return r.ApiService.GetShipModulesExecute(r)
}
...
Get the modules installed on a ship.
	...
	@return FleetAPIGetShipModulesRequest
*/
func (a *FleetAPIService) GetShipModules(ctx context.Context, shipSymbol string) FleetAPIGetShipModulesRequest {
	return FleetAPIGetShipModulesRequest{
		ApiService: a,
		ctx:        ctx,
		shipSymbol: shipSymbol,
...
//
//	@return GetShipModules200Response
func (a *FleetAPIService) GetShipModulesExecute(r FleetAPIGetShipModulesRequest) (*GetShipModules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetShipModules200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FleetAPIService.GetShipModules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/my/ships/{shipSymbol}/modules"
	localVarPath = strings.Replace(localVarPath, "{"+"shipSymbol"+"}", url.PathEscape(parameterValueToString(r.shipSymbol, "shipSymbol")), -1)
...
type FleetAPIInstallShipModuleRequest struct {
	ctx                      context.Context
	ApiService               FleetAPI
	shipSymbol               string
...
func (r FleetAPIInstallShipModuleRequest) InstallShipModuleRequest(installShipModuleRequest InstallShipModuleRequest) FleetAPIInstallShipModuleRequest {
	r.installShipModuleRequest = &installShipModuleRequest
	return r
}

func (r FleetAPIInstallShipModuleRequest) Execute() (*InstallShipModule201Response, *http.Response, error) {
	return r.ApiService.InstallShipModuleExecute(r)
}
...
Install a module on a ship. The module must be in your cargo.
	...
	@return FleetAPIInstallShipModuleRequest
*/
func (a *FleetAPIService) InstallShipModule(ctx context.Context, shipSymbol string) FleetAPIInstallShipModuleRequest {
	return FleetAPIInstallShipModuleRequest{
		ApiService: a,
		ctx:        ctx,
		shipSymbol: shipSymbol,
...
//
//	@return InstallShipModule201Response
func (a *FleetAPIService) InstallShipModuleExecute(r FleetAPIInstallShipModuleRequest) (*InstallShipModule201Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *InstallShipModule201Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FleetAPIService.InstallShipModule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/my/ships/{shipSymbol}/modules/install"
	localVarPath = strings.Replace(localVarPath, "{"+"shipSymbol"+"}", url.PathEscape(parameterValueToString(r.shipSymbol, "shipSymbol")), -1)
	...
	// body params
	localVarPostBody = r.installShipModuleRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r FleetAPIPatchShipNavRequest) Execute() (*PatchShipNav200Response, *http.Response, error) {
...
//
//	@return PatchShipNav200Response
func (a *FleetAPIService) PatchShipNavExecute(r FleetAPIPatchShipNavRequest) (*PatchShipNav200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PatchShipNav200Response
	)
...
type FleetAPIRemoveShipModuleRequest struct {
	ctx                     context.Context
	ApiService              FleetAPI
	shipSymbol              string
...
func (r FleetAPIRemoveShipModuleRequest) RemoveShipModuleRequest(removeShipModuleRequest RemoveShipModuleRequest) FleetAPIRemoveShipModuleRequest {
	r.removeShipModuleRequest = &removeShipModuleRequest
	return r
}

func (r FleetAPIRemoveShipModuleRequest) Execute() (*RemoveModule201Response, *http.Response, error) {
	return r.ApiService.RemoveShipModuleExecute(r)
}
...
Remove a module from a ship. The module will be placed in cargo.
	...
	@return FleetAPIRemoveShipModuleRequest
*/
func (a *FleetAPIService) RemoveShipModule(ctx context.Context, shipSymbol string) FleetAPIRemoveShipModuleRequest {
	return FleetAPIRemoveShipModuleRequest{
		ApiService: a,
		ctx:        ctx,
		shipSymbol: shipSymbol,
...
//
//	@return RemoveModule201Response
func (a *FleetAPIService) RemoveShipModuleExecute(r FleetAPIRemoveShipModuleRequest) (*RemoveModule201Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RemoveModule201Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FleetAPIService.RemoveShipModule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/my/ships/{shipSymbol}/modules/remove"
	localVarPath = strings.Replace(localVarPath, "{"+"shipSymbol"+"}", url.PathEscape(parameterValueToString(r.shipSymbol, "shipSymbol")), -1)
	...
	// body params
	localVarPostBody = r.removeShipModuleRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
