...
func (dst *GetSystemWaypointsTraitsParameter) UnmarshalJSON(data []byte) error {
	...
	err = json.Unmarshal(data, &dst.WaypointTraitSymbol)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ArrayOfWaypointTraitSymbol)
	if err == nil {
...
func (obj GetSystemWaypointsTraitsParameter) GetActualInstanceValue() interface{} {
	if obj.WaypointTraitSymbol != nil {
		return *obj.WaypointTraitSymbol
	}
